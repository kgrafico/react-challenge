...
export const Container = props => {
    ...
    return (
        <div id='layout' className="outer-container">
            ...
            <h2 className="description">Our application can interpret this for you, it just needs you to enter <b>the board size</b> and <b>the coordinates</b> in the input:</h2>
